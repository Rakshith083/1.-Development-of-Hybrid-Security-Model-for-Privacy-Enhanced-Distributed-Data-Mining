...
def showTestData():
    if request.method == 'POST':  
        ...
        return render_template("TstOrg23.html",r=Test_Data,cols=TstCols,dat=Normallized_Test_Data,zip=zip,round=round,l=len(Normallized_Test_Data),angles=angles)
...
def nvb():
    ...
    client.connect(('3.22.15.135',11932))
